# Exercise: Environmental Monitoring Agent
# Complete the following code to implement the new requirements
import asyncio
import os
...
class EnvironmentalAgent(CityAgent):
    """New agent for environmental monitoring (TO BE IMPLEMENTED)"""
    
    def __init__(self):
        super().__init__("Environmental Specialist", "Air quality and environmental monitoring")
        # TODO: Add environmental monitoring functions
        # TODO: Initialize with air quality monitoring capabilities
        
    async def process_request(self, request: str) -> str:
        """Process environmental monitoring requests"""
        # TODO: Implement environmental analysis logic
        # TODO: Simulate air quality data collection
        return "Environmental analysis result (to be implemented)"

class EnhancedCityCoordinator(CityCoordinator):
    """Enhanced coordinator with environmental agent"""
    
    def __init__(self):
        super().__init__()
        # TODO: Add the new environmental agent
        # self.agents["environmental"] = EnvironmentalAgent()
    
    async def coordinate_monitoring(self, monitoring_request: str) -> Dict[str, str]:
        """Enhanced coordination with environmental monitoring"""
        # TODO: Add environmental agent to processing
        results = await super().coordinate_monitoring(monitoring_request)
        
        # TODO: Add simple storage simulation
...
async def run_exercise():
    print("Exercise: Environmental Monitoring Extension")
    print("===========================================")
    
    coordinator = EnhancedCityCoordinator()
    
    monitoring_request = "Analyze current environmental conditions and air quality"
    
    print(f"Monitoring Request: {monitoring_request}")
    print("-" * 60)
    
    results = await coordinator.coordinate_monitoring(monitoring_request)
    ...
    print("Exercise completed! Implement the EnvironmentalAgent to complete the solution.")
